...
Version  : 1.7.10
Release  : 22
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/arules_1.7-10.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/arules_1.7-10.tar.gz
...
%setup -q -n arules
pushd ..
cp -a arules buildavx2
popd
pushd ..
cp -a arules buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745419007
...
/usr/lib64/R/library/arules/tests/testthat/test-eclat.R
/usr/lib64/R/library/arules/tests/testthat/test-extract.R
/usr/lib64/R/library/arules/tests/testthat/test-fim4r.R
...
/usr/lib64/R/library/arules/tests/testthat/test-mine_concise.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/arules/libs/arules.so
/V4/usr/lib64/R/library/arules/libs/arules.so
